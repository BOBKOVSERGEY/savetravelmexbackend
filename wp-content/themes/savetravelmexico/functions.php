...
function stmPostTypes () {
  ...
  register_post_type('wedding', [
    'labels' => [
      'name'               => 'Пакеты для свадьбы', // основное название для типа записи
      ...
      'parent_item_colon'  => '', // для родителей (у древовидных типов)
      'menu_name'          => 'Пакеты для свадьбы', // название меню
    ],
    'public'              => true,
    'publicly_queryable'  => false, // убираем возможность перейти
    'exclude_from_search' => true, // убираем из поиска
  ...
  register_post_type('security', [
    'labels' => [
      'name'               => 'Пакеты для охраны', // основное название для типа записи
      'singular_name'      => 'Пакет', // название для одной записи этого типа
      'add_new'            => 'Добавить пакет', // для добавления новой записи
      'add_new_item'       => 'Добавить новый пакет', // заголовка у вновь создаваемой записи в админ-панели.
      'edit_item'          => 'Редактирование пакета', // для редактирования типа записи
      ...
      'not_found_in_trash' => 'Не найдено в корзине пакета', // если не было найдено в корзине
      'parent_item_colon'  => '', // для родителей (у древовидных типов)
      'menu_name'          => 'Пакеты для охраны', // название меню
    ],
    'public'              => true,
    'publicly_queryable'  => false, // убираем возможность перейти
    'exclude_from_search' => true, // убираем из поиска
  ...
  register_post_type('dentist', [
    'labels' => [
      'name'               => 'Пакеты для стоматологического туризма', // основное название для типа записи
      'singular_name'      => 'Пакет', // название для одной записи этого типа
      'add_new'            => 'Добавить пакет', // для добавления новой записи
      'add_new_item'       => 'Добавить новый пакет', // заголовка у вновь создаваемой записи в админ-панели.
      'edit_item'          => 'Редактирование пакета', // для редактирования типа записи
      ...
      'not_found_in_trash' => 'Не найдено в корзине пакета', // если не было найдено в корзине
      'parent_item_colon'  => '', // для родителей (у древовидных типов)
      'menu_name'          => 'Пакеты для стоматологического туризма', // название меню
    ],
    'public'              => true,
    'publicly_queryable'  => false, // убираем возможность перейти
    'exclude_from_search' => true, // убираем из поиска
